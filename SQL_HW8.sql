...
-- 1. агрегирующая функция MIN&MAX;
...
select * from trip_driver;
 ...
 -- 4. функция AVERAGE & ROUND
 select round(avg(rate_hour),2) as BYN from driver;
 
-- 5. функция с having&group by 
...
-- 6. функция case: вывести имя  и фам водителя, почасовую ставку, и доп. столбец rate_category, где
